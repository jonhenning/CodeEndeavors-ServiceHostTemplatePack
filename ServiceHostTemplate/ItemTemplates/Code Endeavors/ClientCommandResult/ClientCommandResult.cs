...
namespace $defaultnamespace$
{
    ...
    public class $safeitemname$<TData>
    {
        private TData _data;
        ...
        public $safeitemname$(bool startTimer)
        {
        ...
        public void ReportResult($safeitemname$<TData> result, bool success)
        {
            this.Success = result.Success;
            this.Data = result.Data;
        ...
        public void ReportResult<T2>($safeitemname$<T2> result, TData data, bool success)
        {
            this.Success = result.Success;
            this.Data = data;
            this.ServerExecutionTime = result.ServerExecutionTime;
        ...
        public static $safeitemname$<TData> Execute(Action<$safeitemname$<TData>> codeFunc) 
        {
            var result = new $safeitemname$<TData>(true);
            try
            {
